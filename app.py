...
# MongoDB connection
client = MongoClient('mongodb+srv://manasmaity493:manas123@cluster0.vpnstgh.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0')
...
# Load Haar cascade from OpenCV data path
...
# Function to train the model on available faces
def train_model():
    faces = []
    labels = []
...
# Function to extract attendance from MongoDB
...
# Function to add attendance of a user
